...
const socials = [
  {
    icon: Mail,
    label: 'Email',
    href: 'mailto:admin@manpreetsingh.co.in',
    display: 'admin@manpreetsingh.co.in',
  ...
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/manpreetsingh78/',
    display: 'linkedin.com/in/manpreetsingh78',
  ...
  },
  {
    icon: Github,
    label: 'GitHub',
    href: 'https://github.com/manpreetsingh78/',
    display: 'github.com/manpreetsingh78',
